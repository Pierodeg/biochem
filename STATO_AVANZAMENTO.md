...
| F1 | Estendere campi configurabili (H1) | 🔄 bloccato tecnicamente: `CampoConfigurabile` non ha validator, i campi lab sono obbligatori → prima va aggiunta la validazione al widget pilota |
